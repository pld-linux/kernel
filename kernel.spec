...
# based on http://vserver.13thfloor.at/Experimental/patch-2.6.34.1-vs2.3.0.36.30.4.pre8.diff
...
# http://kernel.org/pub/linux/security/apparmor/AppArmor-2.6/apparmor-v2.6+v2.4-compat-for-2.6.34.patch
...
# based on http://www.grsecurity.net/~spender/grsecurity-2.2.0-2.6.34-201007031927.patch
