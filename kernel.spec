...
Summary(pl.UTF-8):   Jądro Linuksa %{version} skompilowane dla maszyn wieloprocesorowych
Group:		Base/Kernel
...
Summary(pl.UTF-8):   Moduły PCMCIA-CS 
Group:		Base/Kernel
...
Moduły PCMCIA-CS (%{pcmcia_version}).

%package smp-pcmcia-cs
Summary:	PCMCIA-CS modules for SMP kernel
Summary(pl.UTF-8):   Moduły PCMCIA-CS dla maszyn SMP
Group:		Base/Kernel
Provides:	%{name}-pcmcia-cs = %{pcmcia_version}
