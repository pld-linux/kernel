...
%else # not rescuecd:
%define		__alt_kernel	%{?with_pax:pax}%{!?with_grsecurity:nogrsecurity}%{!?with_pae:nopae}
%if "%{__alt_kernel}" != ""
...
# Source1-md5:	c0f416f6a2e916633f697287cc7cb914
%endif
...
# http://vserver.13thfloor.at/Experimental/patch-2.6.38.7-vs2.3.0.37-rc17.diff
