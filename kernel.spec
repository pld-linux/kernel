...
Summary(de):	Kernel kernel_version %{kernel_version} für Installationsdisketten
...
Dieses Paket enthält eine verkleinerte kernel_version vom Linux-Kernel
...
Ce package inclut une kernel_version allégée du noyau de Linux kernel_version
%{kernel_version}. Ce kernel et utilisé pour les disquettes de boot
...
Ten pakiet zawiera okrojon± wersjê kernela %{kernel_version}. U¿ywana jest
